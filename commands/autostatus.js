...
async function autoStatusCommand(sock, chatId, msg, args) {
    try {
        ...
        if (!args || args.length === 0) {
            ...
            await sock.sendMessage(chatId, { 
                text: `╭═✦〔🔄 *Auto Status Settings* 〕✦═╮\n│\n│📱 *Auto Status View:* ${status}\n│💫 *Status Reactions:* ${reactStatus}\n│\n│ *ᴄᴏᴍᴍᴀɴᴅꜱ*:\n│.autostatus on - ᴇɴᴀʙʟᴇ ᴀᴜᴛᴏ ꜱᴛᴀᴛᴜꜱ ᴠɪᴇᴡ\n│.autostatus off - ᴅɪꜱᴀʙʟᴇ ᴀᴜᴛᴏ ꜱᴛᴀᴛᴜꜱ ᴠɪᴇᴡ\n│.autostatus react on - ᴇɴᴀʙʟᴇ ꜱᴛᴀᴛᴜꜱ ʀᴇᴀᴄᴛɪᴏɴꜱ\n│.autostatus react off - ᴅɪꜱᴀʙʟᴇ ꜱᴛᴀᴛᴜꜱ ʀᴇᴀᴄᴛɪᴏɴꜱ\n╰═✦═✦═✦═✦═✦═✦═✦═✦═✦═╯`,
                ...channelInfo
            });
            return;
        }
