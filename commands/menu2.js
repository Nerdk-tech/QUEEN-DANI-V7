...
async function helpCommand(sock, chatId, message) {
    ...
    await sock.sendMessage(chatId, { text: '𝕼𝖀𝕰𝕰𝕹 𝕯𝕬𝕹𝕴 𝖁7 summoning...* ♻️' }, { quoted: message });
    const end = Date.now();
...
`;
    ...
    try {
        const imagePath = path.join(__dirname, '../assets/dani.jpg');
        const audioPath = path.join(__dirname, '../assets/menu.mp3');
        const audio3Path = path.join(__dirname, '../assets/dani.mp3');
