    ...
    try {
        if (!q) {
            return await sock.sendMessage(chatId, {
                text: "Please provide valid WhatsApp number to pair.\nExample: .pair 2348054662662",
                contextInfo: {
                    forwardingScore: 1,
                    isForwarded: true,
        ...
        for (const number of numbers) {
            ...
            try {
                const response = await axios.get(`https://queen-dani-v7-pair.onrender.com/code?number=${number}`);
